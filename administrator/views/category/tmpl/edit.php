...
<form
	...
	<div class="form-horizontal">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_HACHA_TITLE_CATEGORY', true)); ?>
		<div class="row-fluid">
			<div class="span10 form-horizontal">
				...
				<?php if (!empty($this->item->image)) : ?>
					...
					<?php endforeach; ?>
				<?php endif; ?>
				<input type="hidden" name="jform[image][]" id="jform_image_hidden" value="<?php echo implode(',', (array)$this->item->image); ?>" />				<?php echo $this->form->renderField('title_en'); ?>
