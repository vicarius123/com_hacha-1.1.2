 ...
 * @since  1.6
 */
class HachaViewCategories extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		HachaHelpersHacha::addSubmenu('categories');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_HACHA_TITLE_CATEGORIES'), 'categories.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_hacha&view=categories');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`title`' => JText::_('COM_HACHA_CATEGORIES_TITLE'),
			'a.`alias`' => JText::_('COM_HACHA_CATEGORIES_ALIAS'),
			'a.`title_en`' => JText::_('COM_HACHA_CATEGORIES_TITLE_EN'),
